...
categories_voc = [{"id": 1, "name": "aeroplane", "supercategory": "VOC"}, {"id": 2, "name": "bicycle", "supercategory": "VOC"}, {"id": 3, "name": "bird", "supercategory": "VOC"}, {"id": 4, "name": "boat", "supercategory": "VOC"}, {"id": 5, "name": "bottle", "supercategory": "VOC"}, {"id": 6, "name": "none", "supercategory": "VOC"}, {"id": 7, "name": "none", "supercategory": "VOC"}, {"id": 8, "name": "cat", "supercategory": "VOC"}, {"id": 9, "name": "chair", "supercategory": "VOC"}, {"id": 10, "name": "cow", "supercategory": "VOC"}, {"id": 11, "name": "diningtable", "supercategory": "VOC"}, {"id": 12, "name": "dog", "supercategory": "VOC"}, {"id": 13, "name": "horse", "supercategory": "VOC"}, {"id": 14, "name": "none", "supercategory": "VOC"}, {"id": 15, "name": "person", "supercategory": "VOC"}, {"id": 16, "name": "pottedplant", "supercategory": "VOC"}, {"id": 17, "name": "sheep", "supercategory": "VOC"}, {"id": 18, "name": "sofa", "supercategory": "VOC"}, {"id": 19, "name": "train", "supercategory": "VOC"}, {"id": 20, "name": "tvmonitor", "supercategory": "VOC"}]
...
class PostProcessCocoGrounding(nn.Module):
    ...
    def __init__(self, num_select=300, coco_api=None, tokenlizer=None) -> None:
        ...
        category_dict = categories_vehicle + categories_aerial + categories_aqua + categories_rabbit + categories_egohand + categories_mushroom + categories_package + categories_voc + categories_pistol + categories_pothole + categories_raccoon + categories_shellfish + categories_thermal
