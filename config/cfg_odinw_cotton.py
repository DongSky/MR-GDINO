...
freeze_keywords =  ['bert','backbone.0','feat_map','input_proj','transformer','coop']                         # for whole model, e.g. ['backbone.0', 'bert'] for freeze visual encoder and text encoder
# freeze_keywords =  ['bert','backbone.0','feat_map','input_proj','transformer']     
