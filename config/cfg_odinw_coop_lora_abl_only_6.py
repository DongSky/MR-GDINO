...
lr = 0.04                                  # base learning rate
backbone_freeze_keywords = None               # only for gdino backbone
freeze_keywords =  ['bert','backbone.0','feat_map','input_proj','transformer']                         # for whole model, e.g. ['backbone.0', 'bert'] for freeze visual encoder and text encoder
...
lr_transformer_names = ['transformer.encoder.fusion_layers']
lora_disable_layers = [0,1,2,3,4]
weight_decay = 0.01
