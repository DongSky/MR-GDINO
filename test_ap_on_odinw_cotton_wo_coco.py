...
class PostProcessCocoGrounding(nn.Module):
    ...
    def __init__(self, num_select=300, coco_api=None, tokenlizer=None) -> None:
        ...
        category_dict = categories_rabbit + categories_aerial + categories_aqua+  categories_egohand + categories_mushroom + categories_package + categories_voc + categories_pistol + categories_pothole + categories_raccoon + categories_shellfish + categories_thermal + categories_vehicle
...
def main(args):
    ...
    category_dict = categories_rabbit +  categories_aqua + categories_aerial  + categories_egohand + categories_mushroom + categories_package + categories_voc + categories_pistol + categories_pothole + categories_raccoon + categories_shellfish + categories_thermal + categories_vehicle
    cat_list = [item['name'] for item in category_dict]
