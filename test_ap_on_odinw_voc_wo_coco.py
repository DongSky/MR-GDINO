...
class PostProcessCocoGrounding(nn.Module):
    ...
    def __init__(self, num_select=300, coco_api=None, tokenlizer=None) -> None:
        ...
        category_dict = categories_voc + categories_aerial + categories_aqua + categories_rabbit + categories_egohand + categories_mushroom + categories_package +  categories_pistol + categories_pothole + categories_raccoon + categories_shellfish + categories_thermal + categories_vehicle
