    ...
    for samples, targets in metric_logger.log_every(data_loader, print_freq, header, logger=logger):
        ...
        with torch.cuda.amp.autocast(enabled=args.amp):
            if not args.use_zira:
                ...
                outputs, loss_zira_text, loss_zira_image = model(samples, captions=captions)
            # print(outputs)
            # exit()
            ...
            if args.use_zira:
                loss_dict['loss_zira_text'] = loss_zira_text
                loss_dict['loss_zira_image'] = loss_zira_image
                
                weight_dict['loss_zira_text'] = 0.1
                weight_dict['loss_zira_image'] = 0.1
        ...
        # unused_params = [param for param in model.parameters() if param.grad is None]
        # dummy_loss = 0
        # for param in unused_params:
        #     dummy_loss += 0.0 * param.sum()
